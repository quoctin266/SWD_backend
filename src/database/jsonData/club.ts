...
export const footballClubData: IClub[] = [
  {
...
export const basketballClubData: IClub[] = [
  {
    name: 'Sky Hoopers',
...
export const badmintonClubData: IClub[] = [
  {
...
export const tennisClubData: IClub[] = [
  {
    name: 'Ace Aces',
    email: 'aceaces@gmail.com',
    description:
      'Ace Aces is a tennis club where precision meets power, aiming for excellence both on and off the court.',
  },
  {
    name: 'Rally Rovers',
    email: 'rallyrovers@gmail.com',
    description:
      'Rally Rovers is a dynamic tennis club that values teamwork, consistency, and a relentless pursuit of improvement.',
  },
  {
    name: 'Serene Netmasters',
    email: 'serenenetmasters@gmail.com',
    description:
      'Serene Netmasters is a tennis club that brings together players who appreciate the grace and finesse of the game.',
  },
];

export const volleyballClubData: IClub[] = [
  {
    name: 'Spike Surge',
    email: 'spikesurge@gmail.com',
    description:
      'Spike Surge is a volleyball club that thrives on powerful spikes, solid blocks, and a strong sense of team spirit.',
  },
  {
    name: 'Eclipse Smashers',
    email: 'eclipsesmashers@gmail.com',
    description:
      'Eclipse Smashers is a dynamic volleyball club that combines strategy, agility, and powerful smashes on the court.',
  },
  {
    name: 'Aurora Spikers',
    email: 'auroraspikers@gmail.com',
    description:
      'Aurora Spikers is a volleyball club that aims to illuminate the court with exceptional teamwork, communication, and sportsmanship.',
  },
];
