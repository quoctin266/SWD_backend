...
let Member = class Member {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, isLeader: { required: true, type: () => Boolean }, user: { required: true, type: () => require("../../users/entities/user.entity").User }, club: { required: true, type: () => require("../../clubs/entities/club.entity").Club }, joinedEvents: { required: true, type: () => [require("../../events/entities/event.entity").Event] }, createdAt: { required: true, type: () => Date }, updatedAt: { required: true, type: () => Date }, deletedAt: { required: false, type: () => Date } };
    }
};
