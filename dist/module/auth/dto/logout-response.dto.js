...
class LogoutResponse {
    static _OPENAPI_METADATA_FACTORY() {
        return { statusCode: { required: true, type: () => Number }, message: { required: true, type: () => String }, data: { required: true, type: () => String } };
    }
}
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: message_1.LOGOUT_SUCCESS }),
    __metadata("design:type", String)
], LogoutResponse.prototype, "message", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: 'string', default: null }),
    __metadata("design:type", String)
], LogoutResponse.prototype, "data", void 0);
